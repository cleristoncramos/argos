...
ASSETS: list[AssetRecord] = [
    ...
    _asset("VNQ", "Vanguard Real Estate ETF", "REIT/ETF", "Imobiliário", "EUA", "Carteira diversificada de REITs", "reits", data_type="reit"),
    ...
    _asset("CL=F", "WTI Crude Oil", "Commodity", "Energia", "EUA/NYMEX", "Petróleo WTI", "commodities"),
    _asset("BZ=F", "Brent Crude", "Commodity", "Energia", "Global/ICE", "Petróleo Brent", "commodities"),
    _asset("NG=F", "Natural Gas", "Commodity", "Energia", "EUA/NYMEX", "Gás natural", "commodities"),
    _asset("ZS=F", "Soybean", "Commodity", "Agrícola", "EUA/CBOT", "Soja", "commodities"),
    _asset("ZC=F", "Corn", "Commodity", "Agrícola", "EUA/CBOT", "Milho", "commodities"),
    _asset("ZW=F", "Wheat", "Commodity", "Agrícola", "EUA/CBOT", "Trigo", "commodities"),
    _asset("KC=F", "Coffee", "Commodity", "Agrícola", "EUA/ICE", "Café", "commodities"),
    _asset("CC=F", "Cocoa", "Commodity", "Agrícola", "EUA/ICE", "Cacau", "commodities"),
    _asset("SB=F", "Sugar", "Commodity", "Agrícola", "EUA/ICE", "Açúcar", "commodities"),
    _asset("CT=F", "Cotton", "Commodity", "Agrícola", "EUA/ICE", "Algodão", "commodities"),

    _asset("^IRX", "Treasury 13 Weeks", "Renda Fixa", "Curto prazo", "EUA", "Yield de Treasury de 13 semanas", "treasury"),
    _asset("^FVX", "Treasury 5 Years", "Renda Fixa", "Médio prazo", "EUA", "Yield de Treasury de 5 anos", "treasury"),
    _asset("^TNX", "Treasury 10 Years", "Renda Fixa", "Longo prazo", "EUA", "Yield de Treasury de 10 anos", "treasury"),
    _asset("^TYX", "Treasury 30 Years", "Renda Fixa", "Longo prazo", "EUA", "Yield de Treasury de 30 anos", "treasury"),
    _asset("^US2Y", "Treasury 2 Years", "Renda Fixa", "Curto/médio prazo", "EUA", "Yield de Treasury de 2 anos", "treasury"),
    _asset("^US3M", "Treasury 3 Months", "Renda Fixa", "Curto prazo", "EUA", "Yield de Treasury de 3 meses", "treasury"),
    _asset("^US1Y", "Treasury 1 Year", "Renda Fixa", "Curto prazo", "EUA", "Yield de Treasury de 1 ano", "treasury"),
]
